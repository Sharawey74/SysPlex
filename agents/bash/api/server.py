...
# Configuration
API_PORT = 8888
API_HOST = os.getenv("SYSPLEX_BASH_AGENT_HOST", "127.0.0.1")
REPO_ROOT = Path(__file__).resolve().parents[3]
METRICS_FILE = REPO_ROOT / "data" / "metrics" / "latest.json"
MONITOR_SCRIPT = Path(__file__).resolve().parents[1] / "monitors" / "main_monitor.sh"
